		...
		<div class="container panel-margin">
			...
			<div class="row text-center">
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
                                            <img src="images/5.jpg" alt="responsive img"/>
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
                                            <img src="images/2.jpg" alt="responsive img"/>
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
                                             <img src="images/3.jpg" alt="responsive img"/>
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
                                            <img src="images/4.jpg" alt="responsive img"/>
			...
			<div class="row text-center">
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
                                             <img src="images/9.jpg" alt="responsive image"/>
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						  <img src="images/10.jpg" alt="responsive image"/>
						<div class="caption">
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						   <img src="images/11.jpg" alt="responsive image"/>
						<div class="caption">
							<h3>HMT Milan</h3>
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						 <img src="images/12.jpg" alt="responsive image"/>
						<div class="caption">
			...
			<div class="row text-center">
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						 <img src="images/22.jpg" alt="responsive image"/>
						<div class="caption">
							<h3> H & W</h3>
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						 <img src="images/6.jpg" alt="responsive image"/>
						<div class="caption">
							<h3>Luis Phil</h3>
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						 <img src="images/13.jpg" alt="responsive image"/>
						<div class="caption">
							<h3>John Zok </h3>
							<p>Price: <i class="fa fa-rupee">1500.00</i></p>
							<?php if(!isset($_SESSION["email_id"])){ ?>
							<a href="login.php" type="button" class="btn btn-primary">Add to cart</a>
							<?php }else{ ?>
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						 <img src="images/14.jpg" alt="responsive image"/>
						<div class="caption">
							<h3>Jhalsani</h3>
							<p>Price: <i class="fa fa-rupee">13000.00</i></p>
							<?php if(!isset($_SESSION["email_id"])){ ?>
							<a href="login.php" type="button" class="btn btn-primary">Add to cart</a>
							<?php }else{ ?>
